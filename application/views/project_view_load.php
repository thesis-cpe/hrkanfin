...
<!-- <link rel="stylesheet" href="dist/css/ionicons.min.css"> -->
  ...
  <![endif]-->
  <!--Redirect-->
  <meta http-equiv="refresh" content="3;url=<?php echo base_url();?>index.php/project" />
</head>
<!--
BODY TAG OPTIONS:
=================
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">ข้อความจากระบบ...</h3>
        ...
        <div class="box-body" style="display: block;">
            <center><p>บันทึกข้อมูลเรียบร้อยแล้ว ระบบจะนำพาท่านไปยังหน้า<a>โครงการ</a>ในอีก 3 วินาที</p></center>
        </div>
        <!-- /.box-body -->
        <div class="box-footer" style="display: block;">
            <center><a href="<?php echo base_url();?>index.php/project"><button class="btn btn-sm btn-default">ไปยังหน้าข้อมูลหลักทันที</button></center></a>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
