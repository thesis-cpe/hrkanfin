                ...
                <section class="content">
                    ...
                    <div class="box box-info">
                        ...
                        echo "selected";
                                        ...
                                        <option <?php if ($customer_detail['customer_status'] == "สถานศึกษา") {
                        echo "selected";
                    } ?>  value="สถานศึกษา">สถานศึกษา</option>
                                ...
                                <div class="col-sm-2">
                                    ...
                                    foreach ($sing as $rowSign):?>    
                                        <select class="form-control" name="selStatusCondition[]" id="selStatusCondition1">
                                            ...
                                            <option <?php if($rowSign['status'] == "ผู้อำนวยการ"){echo "selected";}?> value="ผู้อำนวยการ">ผู้อำนวยการ</option>
