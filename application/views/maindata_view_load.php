    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body" style="display: block;">
            <center><p>บันทึกข้อมูลเรียบร้อยแล้ว ระบบจะนำพาท่านไปยังหน้า<a>ข้อมูลหลัก</a>ในอีก 3 วินาที</p></center>
        </div>
        <!-- /.box-body -->
        <div class="box-footer" style="display: block;">
            <center><a href="<?php echo base_url();?>index.php/main_data"><button class="btn btn-sm btn-default">ไปยังหน้าข้อมูลหลักทันที</button></center></a>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
