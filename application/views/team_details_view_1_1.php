                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">แนบเอกสารคุยงาน</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="container">
                                <div class="col-sm-4"> <!--ข้อความ-->
                                        ...
                                        <div class="box-footer">
                                            <form action="#" method="post">
                                                <div class="input-group">
                                                    <input type="text" name="message" placeholder="พิมม์ข้อความ ..." class="form-control">
