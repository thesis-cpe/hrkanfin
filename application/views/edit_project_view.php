                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped delete_multiple_check_box">
                                    ...
                                    <tbody>
                                        ...
                                        <!--เพิ่มเติม-->
                                        <td>
                                            <a target="_blank" href="<?php echo base_url();?>index.php/project/add_details2/<?php echo @$teamDetail[$j]['em_id']; ?>/<?php echo @$teamDetail[$j]['team_id']; ?>/<?php echo $projectId;?>" title="เพิ่มรายละเอียด" class="btn btn-sm btn-default"><span class="fa fa-tasks"></a>
